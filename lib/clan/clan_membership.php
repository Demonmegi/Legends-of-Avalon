<?php
		...
		if ($remove>""){
			...
			$sql = "UPDATE " . db_prefix("accounts") . " SET clanrank=".CLAN_APPLICANT.",clanid=0,clanjoindate='0001-01-01 00:00:00' WHERE acctid='$remove' AND clanrank<={$session['user']['clanrank']}";
			db_query($sql);
