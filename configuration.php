...
if ($op == "") {
	...
	$setup = array(
		...
		"defaultlanguage"=>"Default Language,enum,".getsetting("serverlanguages","en,English,fr,Franšais,dk,Danish,de,Deutsch,es,Espa?ol,it,Italian"),
		...
		"useshortbio"=>"Use Popup Bio instead of inline info,bool",
