...
function titlechange_dohook($hookname,$args){
	...
	case "lodge":
		...
		addnav(array("Set Custom Title (%s Donationpoints)`n`\$Achtung:`0Du brauchst hierfür mindestens %s Donationpoints!", get_module_setting("extrapoints"), get_module_setting("initialpoints")),"runmodule.php?module=titlechange&op=titlechange");
		break;
	}
	return $args;
}
