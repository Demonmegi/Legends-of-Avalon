...
function extlinks_getmoduleinfo(){
	$info = array(
		"name"=>"External Links",
		"version"=>"1.0",
		"author"=>"JT Traub, link amount extended by Rohen ",
		"allowanonymous"=>true,
		"category"=>"General",
		...
		"settings"=>array(
			...
			"link5show"=>"Link 5 display locations,bitfield,". 0xffffffff ."
				...
				,".EXTLINK_SHADES.",Shades|0",
			"Link 6,title",
			"link6heading"=>"Nav heading for Link 6|",
			"link6title"=>"Text for Link 6|",
			"link6link"=>"URL for Link 6|",
			"link6show"=>"Link 6 display locations,bitfield,". 0xffffffff ."
				,".EXTLINK_INDEX.",Index page
				,".EXTLINK_VILLAGE.",Village
				,".EXTLINK_SHADES.",Shades|0",
			"Link 7,title",
			"link7heading"=>"Nav heading for Link 7|",
			"link7title"=>"Text for Link 7|",
			"link7link"=>"URL for Link 7|",
			"link7show"=>"Link 7 display locations,bitfield,". 0xffffffff ."
				,".EXTLINK_INDEX.",Index page
				,".EXTLINK_VILLAGE.",Village
				,".EXTLINK_SHADES.",Shades|0"
		),
...
function extlinks_dohook($hookname,$args){
	...
	case "index":
		...
		// addnav("Andere Server");
		// addnav("Import Venar-Char","runmodule.php?import");
		break;
	default: return $args;
	}
