...
function dragonattack_runevent($type)
{
	...
	if(get_module_pref("dayspast") >= 15 ){

		apply_buff( "divine-help",
			array(
			'minbadguydamage' => 1000000,
			'maxbadguydamage' => 1000000,
			'rounds' => 1,
			'minioncount' => 1,
			'effectmsg' => "`&Ein göttlicher Blitz trifft deinen Gegner und läßt ihn unter Qualen zu Boden sinken",)
		);
