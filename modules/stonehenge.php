...
function stonehenge_getmoduleinfo(){
	$info = array(
		...
		"settings"=>array(
			...
			"findchance"=>"Chance of encountering?,int|100",
		),
		"prefs"=>array(
...
function stonehenge_install(){
	...
	module_addeventhook("forest", "require_once(\"modules/stonehenge.php\"); return stonehenge_test();");
...
function stonehenge_test(){
	global $session;		
	$chance = get_module_setting("findchance","stonehenge");	
	if (get_module_pref("happened","stonehenge") == 1) return 0; 	 
	return $chance; 
}
