...
function specialtydarkarts_dohook($hookname,$args){
  ...
  case "newday":
    ...
    if( isset($companions['skeleton_warrior']) ){
      output("`4`nDein Skelettkrieger zerfällt angesichts des anbrechenden Tages zu Staub.`n");
      ...
      if (get_module_pref("uses") >= $l){
        ...
        case 1:
          if (getsetting("enablecompanions", true)) {
            apply_companion('skeleton_warrior', array(
              ...
              "dyingtext"=>"`\$Dein Skelettkrieger zerfällt zu Staub.`n",
              "abilities"=>array(
                "fight"=>true,
              ),
              "cannotbehealed"=>true,
        ...
        case 3:
          apply_buff('da3', array(
            "startmsg"=>"`\$Deine Waffe glüht in einem überirdischen Licht.",
            "name"=>"`\$Leben absaugen",
        ...
        case 4:
          ...
          apply_buff('da4',array(
            "startmsg"=>"`\$Du opferst einen Teil deiner Lebenskraft, um deine Macht kurzzeitig zu vergrößern.",
            "name"=>"`\$Woge der Macht",
            "rounds"=>3,
            "wearoff"=>"`)Die Woge der Macht versiegt wieder.",
            "atkmod"=>2,
            "defmod"=>2,
            "roundmsg"=>"`)Mit unnatürlicher Stärke stürzt du dich auf {badguy}.",
            "schema"=>"module-specialtydarkarts"
          ));
          break;          
        case 5:
          ...
          apply_buff('da5',array(
            "startmsg"=>"`\$Mit einer dünnen Klinge schneidest du in deine Hand, besudelst {badguy}`\$ mit deinem Blut und murmelst einige düstere Worte.",
            "name"=>"`\$Seelenqual",
            "rounds"=>5,
            "wearoff"=>"`)Die Seele deines Gegners erholt sich.",
            "badguyatkmod"=>0,
            "badguydefmod"=>0,
            "roundmsg"=>"`){badguy}`) windet sich in schrecklichen Qualen jenseits des Körperlichen und ist deinen Attacken hilflos ausgeliefert!",
            "schema"=>"module-specialtydarkarts"
          ));
          break;
        }
